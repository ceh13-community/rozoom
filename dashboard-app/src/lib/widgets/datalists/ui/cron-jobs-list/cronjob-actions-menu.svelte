...
<DropdownMenu.Root bind:open>
  ...
  <DropdownMenu.Content align="end" class="pt-0">
    ...
    <DropdownMenu.Item onSelect={() => selectAction(onTrigger)}>
      <Play class="mr-2 h-4 w-4" />
      Trigger now
    </DropdownMenu.Item>
    <DropdownMenu.Item onSelect={() => selectAction(onToggleSuspend)}>
      <Pause class="mr-2 h-4 w-4" />
      {isSuspended ? "Resume schedule" : "Suspend schedule"}
    </DropdownMenu.Item>

...
const listSource = readFileSync(
  resolve("src/lib/widgets/datalists/ui/nodes-pressures/nodes-pressures-list.svelte"),
  "utf8",
);
const tableSource = readFileSync(
  resolve("src/lib/widgets/datalists/ui/nodes-pressures/data-table.svelte"),
  "utf8",
);

describe("nodes pressures list contract", () => {

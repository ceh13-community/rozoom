...
export const WORKSPACE_WORKLOAD_OPTIONS: WorkspaceWorkloadOption[] = [
  ...
  { value: "helm", label: "Helm Releases", group: "Cluster" },
  // Workloads
...
export const WORKLOAD_LABEL_OVERRIDES: Record<string, string> = {
  ...
  deprecationscan: "API Deprecation Scan",
  alertshub: "Cluster Alerts",
  armorhub: "KubeArmor",
  backupaudit: "Backup Status",
  helm: "Helm Releases",
  ...
  capacityintelligence: "Cost & Efficiency",
